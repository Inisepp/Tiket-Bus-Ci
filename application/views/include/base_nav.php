  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('backend/home') ?>">
        ...
        <div class="sidebar-brand-text mx-3">Admin Tiket Bus</div>
      </a>
      ...
      <li class="nav-item">
        ...
        <a class="nav-link" href="<?php echo base_url() ?>konfirmasi">
        ...
        <a class="nav-link" href="<?php echo base_url() ?>rute">
          ...
          <span>Tujuan</span></a>
        <a class="nav-link" href="<?php echo base_url() ?>bus">
          ...
          <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo base_url('pelanggan') ?>">List Pelanggan</a>
                <a class="collapse-item" href="<?php echo base_url() ?>admin">List Admin</a>
              </div>
            </div>
          </li>
        <?php }else{ } ?>
