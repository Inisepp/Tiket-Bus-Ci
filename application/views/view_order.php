  ...
  <body id="page-top">
    ...
    <div class="container-fluid">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <form action="<?php echo base_url().'order/inserttiket' ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="row form-group">
                    ...
                    <div class="col-sm-8">
                      <a href="<?php echo base_url('konfirmasi/viewkonfirmasi/'.$tiket[0]['kd_order']) ?>" class="btn btn-secondary">Lihat</a>
                    </div>
                  </div>
                </div>
                <div class="col-sm-6">
              ...
              <hr><a class="btn btn-default" href="<?php echo base_url().'order' ?>"> Kembali</a>
            ...
            <?php }else{ ?>
              ...
              <a class="btn btn-success" href="<?php echo base_url('order/kirimemail/'.$row['kd_order']) ?>"> Kirim Eticket</a>
                        <?php } ?>
            </div>
          </div>
        </form>
